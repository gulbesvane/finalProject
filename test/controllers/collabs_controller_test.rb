...
class CollabsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collab" do
    assert_difference("Collab.count") do
      post collabs_url, params: { collab: { body: @collab.body, integer: @collab.integer, participants: @collab.participants, title: @collab.title } }
    end
  ...
  test "should update collab" do
    patch collab_url(@collab), params: { collab: { body: @collab.body, integer: @collab.integer, participants: @collab.participants, title: @collab.title } }
